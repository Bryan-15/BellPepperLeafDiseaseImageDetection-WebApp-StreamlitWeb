...
if choice == "HOME":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown("<h1 style='text-align: center; color: red;'>WELCOME TO THE HOME PAGE</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: red;'>BELL PEPPER LEAF DISEASE INFORMATIONS</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: red;'>Bacterial Spots</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: red;'>Description </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: red;'>Cause </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: red;'>Solution/Treatment </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: red;'>Cercospora Leaf Spots</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: red;'>Description </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: red;'>Powdery Mildew</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: red;'>Description </h2>", unsafe_allow_html=True)
...
if choice=="ABOUT US":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown("<h1 style='text-align: center; color: red;'>WELCOME TO ABOUT US PAGE</h1>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h1 style='text-align: center; color: red;'>System Features:</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: red;'>Home Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: red;'>Image Detection Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h2 style='text-align: center; color: red;'>About Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h2 style='text-align: center; color: red;'>Contact Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
...
if choice=="CONTACT":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown("<h1 style='text-align: center; color: red;'>WELCOME TO CONTACT PAGE</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: red;'>YOU CAN CONTACT US THROUGH</h2>", unsafe_allow_html=True)
        st.markdown('##')

        
        st.markdown("<h2 style='text-align: center; color: red;'>Contacts For:</h2>", unsafe_allow_html=True)
