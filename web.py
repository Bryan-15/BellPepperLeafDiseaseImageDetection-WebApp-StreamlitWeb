...
if choice == "HOME":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: white;'>Bacterial Spots</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: white;'>Description </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: white;'>Cause </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: white;'>Solution/Treatment </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: white;'>Cercospora Leaf Spots</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: white;'>Description </h2>", unsafe_allow_html=True)
        ...
        st.markdown('##')
        st.markdown('##')
        st.markdown("<h1 style='text-align: center; color: white;'>Powdery Mildew</h1>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: white;'>Description </h2>", unsafe_allow_html=True)
...
if choice=="ABOUT US":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown("<h1 style='text-align: center; color: white;'>WELCOME TO ABOUT US PAGE</h1>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h1 style='text-align: center; color: white;'>System Features:</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: white;'>Home Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: white;'>Image Detection Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h2 style='text-align: center; color: white;'>About Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
        ...
        st.markdown("<h2 style='text-align: center; color: white;'>Contact Page:</h2>", unsafe_allow_html=True)
        st.markdown('##')
...
if choice=="CONTACT":
    with st.spinner('Loading Please Wait...'):
        ...
        st.markdown("<h1 style='text-align: center; color: white;'>WELCOME TO CONTACT PAGE</h1>", unsafe_allow_html=True)
        st.markdown('##')
        st.markdown("<h2 style='text-align: center; color: white;'>YOU CAN CONTACT US THROUGH</h2>", unsafe_allow_html=True)
        st.markdown('##')

        
        st.markdown("<h2 style='text-align: center; color: white;'>Contacts For:</h2>", unsafe_allow_html=True)
